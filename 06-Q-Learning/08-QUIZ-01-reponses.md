...
# 14. **Dans le contexte du Q-learning, que signifie la convergence ?**
...
# 15. **Quel problème peut survenir si ε reste élevé tout au long de l'apprentissage ?**
...
# 16. **Quel est l'effet d'un faible taux d'apprentissage (α) ?**
...
# 17. **Pourquoi le Q-learning est-il appelé un algorithme "off-policy" ?**
...
# 18. **Quelles sont les deux principales méthodes pour stocker la fonction Q ?**
...
# 19. **Comment s'appelle l'extension du Q-learning qui utilise des réseaux de neurones pour approximer la fonction Q ?**
...
# 20. **Dans Q-learning, qu'est-ce qui déclenche la mise à jour de la fonction Q ?**
...
# 21. **Pourquoi Q-learning est-il considéré comme robuste aux environnements stochastiques ?**
